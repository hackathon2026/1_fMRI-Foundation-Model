...
%
% TEST COMMENT: Integration test from SwiFT_v2 - 2025-12-30 (루트 파일 테스트)
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%                                                                 %%
...
\author[2]{\fnm{Seokjin} \sur{Moon}}\email{moon97322@snu.ac.kr}

\author[3]{\fnm{Seungjoo} \sur{Lee}}\email{ju980915@snu.ac.kr}

\author[4]{\fnm{Shinjae} \sur{Yoo}}\email{sjyoo@bnl.gov}
...
\affil[2]{\orgdiv{Department of Brain and Cognitive Sciences}, \orgname{Seoul National University}, \orgaddress{\city{Seoul}, \postcode{08826}, \country{South Korea}}}
...
\affil[4]{\orgdiv{Artificial Intelligence Department}, \orgname{Brookhaven National Laboratory}, \orgaddress{\city{Upton}, \postcode{11973}, \state{New York},  \country{USA}}}
